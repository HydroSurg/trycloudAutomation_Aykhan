...
public class US6_RemoveAndUploads_StepDefs {
    ...
    public void the_user_clicks_the_add_icon_on_the_top() {
        BrowserUtils_Gurhans.waitForClickablility(filesPage.addIcon,10);
...
//        }
    ...
    Assert.assertTrue(filesPage.uploadedFile(filesPage.fileName).isDisplayed());

        // Remove uploaded file
        filesPage.clickOnSpecificActionsButton(filesPage.fileName);
